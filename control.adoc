...
https://docs.riscv.org/reference/debug-trace-ras/trace-control-interface/_attachments/RISC-V-Trace-Control-Interface.pdf[RISC-V Trace Control Interface Specification] should be used.
...
|*trTeInstStallEn* | O |
|*trTeDataStallEn* | OD |
|*trTeEmpty* | O | Recommended if the trace datapath requires manual flushing +
...
|*trTeContext* | O |
|*trTeInstMode* | N | Hardcode to 6.
|*trTeInstImplicitReturnMode* |  0|
