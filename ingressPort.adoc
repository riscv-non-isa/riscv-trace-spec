...
* If context is supported then the _instruction_address_ for:
...
[align="center",float="center",cols="<27%,<7%,<~"options="header"]
|===
...
[align="center",float="center",cols="<26%,<8%,<~",options="header"]
|===
| *Signal* | *Group* | *Function*
...
[align="center",float="center",cols="<32%,<7%,<~",options="header"]
|===
| *Signal* | *Group* | *Function*
