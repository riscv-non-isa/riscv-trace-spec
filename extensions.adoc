[[sec:ext-support]]
== Standard Support Packet v0.8 extension to Efficient Trace for RISC-V v2.0

[WARNING]
.This chapter is in the link:http://riscv.org/spec-state[Stabilization state]
====
...
[[sec:ext-impret]]
== Implicit Return v0.8 extension to Efficient Trace for RISC-V v2.0
...
[[sec:ext-mmacas]]
== Data Trace of Multiple-Memory Access and Compare and Swap v0.8 extension to Efficient Trace for RISC-V v2.0
