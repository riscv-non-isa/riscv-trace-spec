...
The following packet is used for the address/request phase of a split load.

.Packet format for Split load - Address phase
[%autowidth,align="center",float="center",cols="<,<,<",options="header"]
|===
| *Field name* | *Bits* | *Description*
...
This packet is used for the address/request phase of a split atomic:
