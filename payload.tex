...
\begin{table}[htp]
  ...
  \begin{tabulary}{\textwidth}{|l|p{35mm}|p{80mm}|}
    ...
    {\bf Field name} & {\bf Bits} & {\bf Description} \\
    \hline
    \textbf{format}	& 2	& 00 (optional): formats for optional efficiency improvements\\
    \hline
...
These bit are encoded so that most of the time they will take the same value as the \textbf{branch\_map[MSB]} 
