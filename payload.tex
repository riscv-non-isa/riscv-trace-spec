...
\begin{table}[htp]
  ...
  \begin{tabulary}{\textwidth}{|l|p{35mm}|p{90mm}|}
    ...
    \hline
    \textbf{\textcolor{red}{time}} &  \textcolor{red}{\textit {time\_width\_p} or 0 if \textit {notime\_p} is 1} & 
               \textcolor{red}{The time value.}\\
    \hline
...
\textcolor{red}{This packet contains only the context and/or the timestamp, and is output when the context value changes and can be reported imprecisely (see Table~\ref{tab:context-type}).}
