...
\begin{table}[htp]
  ...
  \begin{tabulary}{\textwidth}{|l|p{35mm}|p{90mm}|}
    ...
    \textbf{\textcolor{cyan}{thaddr}} & \textcolor{cyan}{1} &
               \textcolor{cyan}{When set to 1, \textbf{address} points to the trap handler address.  
...
\subsection{\textcolor{cyan}{Format 3 \textbf{thaddr} and \textbf{address} fields}} \label{sec:thaddr}

\textcolor{cyan}{If an exception occurs at the target of an uninferable PC discontinuity, the value of 
...
\textcolor{cyan}{(The reason for not reporting the EPC for all exceptions when \textbf{thaddr} is 0 is
...
\begin{table}[htp]
  ...
  \begin{tabulary}{\textwidth}{|l|p{35mm}|p{90mm}|}
    \hline
     ...
     \hline
     \textbf{\textcolor{cyan}{ienable}} & 1 & Indicates if the \textcolor{cyan}{instruction} trace encoder is enabled\\
     \hline
     ...
     \textbf{qual\_status} & 2 & Indicates qualification status\newline
       ...
       10 (trace\_lost): One or more \textcolor{cyan}{instruction trace} packets lost.\newline
