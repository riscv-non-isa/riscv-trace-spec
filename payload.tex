...
defined (correctly predicted branches and jump target cache).  If only the former is supported, the field can be 
omitted (interpreted as being zero).  The width is specified by the \textit{f0s\_width} discovery field 
(see section~\ref{sec:disco}).  This provision allows additional formats to be added in future without reducing 
