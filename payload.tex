...
Two example transport schemes are the \textcolor{cyan}{Siemens} Messaging Infrastructure, and the Arm Trace Bus.
Figure~\ref{fig:packet-format} shows the encapsulation used for the \textcolor{cyan}{Siemens} infrastructure:
\begin{itemize}
