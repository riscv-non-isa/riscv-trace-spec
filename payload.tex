...
\begin{table}[!h]
  ...
  \begin{tabulary}{\textwidth}{|l|p{35mm}|p{90mm}|}
    ...
    \hline
    \textbf{ircount}	& \textit {call\_counter\_size\_p} & 
                If the value of \textbf{irfail} is different from \textbf{updiscon}, this field indicates 
                the value of the call counter (i.e. the entry number of the return that
                failed).  If \textbf{irfail} is the same value as \textbf{updiscon}, all bits in this field 
                will also be the same value as \textbf{updiscon}. \\
    \hline
  \end{tabulary}
...
\subsection{Format 2 \textbf{irfail}, \textbf{irdepth} and \textbf{ircount} fields} \label{sec:irxx}
...
\subsection{Format 1 \textbf{irfail}, \textbf{irdepth} and \textbf{ircount} fields} \label{sec:irxx}
...
\subsection{Format 0 \textbf{irfail}, \textbf{irdepth} and \textbf{ircount} fields}
