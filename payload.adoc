...
[NOTE]
====
The above packet is deprecated and has been superseded by the equivalent packet defined in the Implicit Return extension (see <<sec:impret>>).  This replaces *irdepth* with *irets*.
====
