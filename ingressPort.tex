...
\begin{table}[htp]
    ...
    \begin{tabulary}{\textwidth}{|l|l|p{80mm}|}
        ...
        Ignored unless \textbf{itype}=\textcolor{cyan}{1}.\\
        \hline
        ...
        Invalid if \textbf{iretire}=0 \textcolor{cyan}{unless \textbf{itype}=1, in which case it indicates the address of the 
...
\begin{table}[htp]
    ...
    \begin{tabulary}{\textwidth}{|l|p{18mm}|p{85mm}|}
        ...
        \hline
        \textbf{trigger}[\textcolor{cyan}{2+}:0] & \textcolor{cyan}{[1:0]: O} \newline 
                                \textcolor{cyan}{[2+]:  OR} & A pulse on bit 0 will cause the encoder to start tracing, and continue until further 
...
\begin{table}[!h]
    ...
    \begin{tabulary}{\textwidth}{|l|p{140mm}|}
        ...
        \textbf{trigger[\textcolor{cyan}{1 + \textit{blocks}:}2]} if the encoder provides it. This will cause the encoder to output
        a packet containing the address of the last instruction in the block if it is enabled.
        \textcolor{cyan}{One bit per block.}\\
        \hline
    \end{tabulary}
\end{table}
...
\begin{table}[htp]
    ...
    \begin{tabulary}{\textwidth}{|l|l|p{80mm}|}
        ...
        \hline
        \textbf{dtype}[\textit{dtype\_width\_p}-1:0] & M & Data access type.  Encoding given in \textcolor{cyan}{Table~\ref{tab:dtype}}\\
        \hline
...
Given that \textcolor{cyan}{\textbf{iretire} is non-zero} in the same cycle that the data access retires, the encoder knows the address of 
