...
\begin{table}[htp]
    ...
    \begin{tabulary}{\textwidth}{|l|l|p{80mm}|}
        ...
        \hline
        \textbf{dresp}[\textit{dresp\_width\_p}-1:0] & MR & The data access size.\\
        \hline        
        \textbf{index}[\textit{index\_width\_p}-1:0] & O & Index used in split transactions.\\
        \hline        
    \end{tabulary}
\end{table}
