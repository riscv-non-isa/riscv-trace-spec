...
\begin{itemize}
  ...
  \item The \textit{instruction\_type} of instructions for:
    \begin{itemize}
      ...
      \item Jumps with a target that \textit{cannot} be inferred from the source code;
      \item Jumps with a target that \textit{can} be inferred from the source code;
      ...
      \item Other jumps which don't fit any of the above classifications with a target that \textit{cannot} be inferred from the source code;
      \item Other jumps which don't fit any of the above classifications with a target that \textit{can} be inferred from the source code.
    \end{itemize}
...
\begin{itemize}
  ...
  \item \textit{Other}: 
    \begin{itemize}
      \item \textbf{\textit{jal}} rd where rd != x0 and rd != x1 and rd != x5;
