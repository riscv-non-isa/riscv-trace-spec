...
\begin{table}[htp]
    ...
    \begin{tabulary}{\textwidth}{|l|l|p{80mm}|}
        ...
        \hline
        \textbf{context}[\textit{context\_width\_p}-1:0] & O & Context and/or hart ID for all instructions in this block.\\
        \hline
        \textbf{ctype}[\textit{ctype\_width\_p}-1:0] & O & Behavior type of \textbf{context}\newline
...
Table~\ref{tab:context-type} specifies the actions for the various \textbf{ctype} values.

\begin{table}[htp]
    \centering
    \caption{Call/return \textbf{ctype} values and corresponding actions}
...
\begin{table}[htp]
    ...
    \begin{tabulary}{\textwidth}{|l|l|p{100mm}|}
        ...
        \hline
        \textbf{halted} & O & Core is halted.  Upon assertion, the encoder will output a packet to report the address 
        ...
        \hline
        \textbf{reset} & O & Core is in reset.  Provided the encoder is in a different reset domain to the hart, this
