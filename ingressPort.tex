...
Support for atomic and CSR accesses is optional.  
...
For harts with out of order or speculative execution capabilites, many loads may be in 
...
\begin{itemize}
  \item The \textit{request} phase provides all information about the load that 
...
\begin{table}[htp]
    ...
    \begin{tabulary}{\textwidth}{|l|l|p{80mm}|}
        ...
        \textbf{Signal} & \textbf{Group} & \textbf{Function} \\
        \hline
        \textbf{dretire} & M & Data access retired\\
        \hline
