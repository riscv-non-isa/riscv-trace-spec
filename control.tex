...
{\color{red}{N.B. When the E-Trace v1.1.3 specification was released
    the draft versions of controls v0 and v1 are incompatible with
    it. However, when these controls are completed the E-Trace
    specification will be ammended to use them.}}
...
\begin{table}[htp]
  ...
  \begin{tabulary}{\textwidth}{|l|l|l|l|l|p{90mm}|}
    ...
    7: always match\\
    \hline
    \textbf{matchMode} & 2 & O & RW & SD & \textcolor{red}{Selects the match condition used to assert the comparator output}\newline
