...
* Adds Chapter 14, which describes extensions to Version 2.0.
* Updated the decoder pseudo-code in section <<Decoder>> to include support for Implicit Return, Branch Predictor and Jump Target Cache optional modes.
