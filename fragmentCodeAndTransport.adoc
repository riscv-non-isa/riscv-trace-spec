...
==== Siemens transport
The packet is encapsulated according to the https://docs.riscv.org/reference/debug-trace-ras/trace-encap/_attachments/e-trace-encap.pdf[Unformatted Trace & Diagnostic Data Packet Encapsulation for RISC-V Specification], with the following attributes:
...
The packet is encapsulated according to the https://docs.riscv.org/reference/debug-trace-ras/trace-encap/_attachments/e-trace-encap.pdf[Trace & Diagnostic Data Packet Encapsulation for RISC-V Specification], with the following attributes:
